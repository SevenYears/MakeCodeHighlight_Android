...
package com.yqs.javacodeparser.openfile;
...
import com.yqs.javacodeparser.R;
...
public class OpenFileDialog {
	...
	// suffix:需要选择的文件后缀，比如需要选择txt、java文件的时候设置为".txt;.java;"，注意最后需要一个分号(;)
	...
	public static Dialog createDialog(int id, Context context, String title, CallbackBundle callback, 
			String suffix, Map<String, Integer> images, String cur_path){
		
		AlertDialog.Builder builder = new AlertDialog.Builder(context);
		builder.setView(new FileSelectView(context, id, callback, suffix, images, cur_path));
	...
	static class FileSelectView extends ListView implements OnItemClickListener{
		...
		public FileSelectView(Context context, int dialogid, CallbackBundle callback, String suffix, Map<String, Integer> images, String cur_path) {
			super(context);
